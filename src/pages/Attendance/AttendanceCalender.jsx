                    ...
                    <RadioButtonWrapper>
                      <div>
                        <RadioInput
                          ...
                          onChange={() =>
                            handleAttendanceChange(item.studentId, "ATTENDANCE")
                          }
                        />
                        <label>출석</label>
                      </div>
                      <div>
                        <RadioInput
                          ...
                          onChange={() =>
                            handleAttendanceChange(item.studentId, "LATE")
                          }
                        />
                        <label>지각</label>
                      </div>
                      <div>
                        <RadioInput
                          ...
                          onChange={() =>
                            handleAttendanceChange(item.studentId, "ABSENCE")
                          }
                        />
                        <label>결석</label>
                      </div>
